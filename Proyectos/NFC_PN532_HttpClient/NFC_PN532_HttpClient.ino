...
String serverIp = "10.100.200.247";
String apiPath = "/node/api.php";
String varName = "data";
...
Serial.println("Hello!");
   ...
   // USE_SERIAL.setDebugOutput(true);
    ...
    WiFiMulti.addAP("AVG", "DDDDDAAAAA00000DDDDDAAAAA00000");

  pinMode(5, OUTPUT);
  digitalWrite(5, HIGH);
  USE_SERIAL.println("PN532 startup");
  delay(4000);
  nfc.begin();
...
void loop() {
  ...
  if (success) {
    ...
    Serial.println("cardIdentifier -> " + cardIdentifier);
